...
- On desktop, article reading should use the browser's native scrolling on `.app-shell__center-scroll`; its padding is the scrollable visual gap, and the visible central surface must remain viewport-bound with surrounding space and border radius intact.
