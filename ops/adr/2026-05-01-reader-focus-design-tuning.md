...
- On desktop, the document should remain the native scroll root, and a fixed non-interactive reader backplate should preserve the central surface, surrounding space, and border radius while page content scrolls.
