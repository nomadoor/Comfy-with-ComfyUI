...
- Localization: when EN/ZH are in scope, compare each complete page with the Japanese source. Preserve all sections, media, links, code, workflow shortcodes, options, and measurements. Matching counts alone are not evidence of parity.
