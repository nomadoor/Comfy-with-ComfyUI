...
色の設定がややこしく、慣れ親しんだ16進数やRGBではなく、24ビットカラーで設定します。

$$ \text{Decimal Value} = (\text{Red} \times 256^2) + (\text{Green} \times 256^1) + (\text{Blue} \times 256^0) $$

デフォルトノードにこだわるので使っていきますが、正直使いにくいですね……