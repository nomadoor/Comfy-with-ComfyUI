...
この画像は、「2フレームに分かれた画像。1フレーム目にはAさんが座っている。2フレーム目ではAさんがこちらを向いている。」のようなプロンプトで生成した1枚の画像です。

見て分かるように、左右に映っている人物は同一人物に見えますね。
これはスプライトシートテクニックといって、一貫性のあるシチュエーションを複数枚作りたいときに、Stable Diffusion 1.5 時代から使われていた方法です。
